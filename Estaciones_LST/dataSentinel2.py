...
def borraJPG(RGB,archivo):
    os.remove('/home/lanot/Documents/Scripts_Tesis/Scripts_Tesis/Estaciones_LST/data_Sentinel2/'+RGB+'/'+archivo)

def borraTodo(archivo):
    borraJPG('TC',archivo)
...
#path = '/home/lanot/Documents/Scripts_Tesis/Scripts_Tesis/Estaciones_LST/data_Sentinel2'
